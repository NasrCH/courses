// sw.js — Service Worker Courses Duo v4
...
// ✅ Notif reçue quand l'app est en ARRIÈRE-PLAN ou FERMÉE (via FCM / Cloudflare Worker)
...
const CACHE_NAME = 'courses-duo-v4';
...
self.addEventListener('fetch', (e) => {
    ...
    // Ne JAMAIS intercepter Firebase/Firestore/Google/Worker — laisser passer direct
    if (
